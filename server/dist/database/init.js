...
async function initDatabase() {
    ...
    const sampleUsers = [
        {
            ...
            age: 25,
            gender: 'female',
            bio: 'Love hiking, coffee, and cozy winter nights. Looking for someone to share this cuffing season with!',
        ...
        },
        {
            ...
            age: 28,
            gender: 'male',
            bio: 'Software engineer who loves trying new restaurants and watching movies. Ready for cuffing season!',
        ...
        },
        {
            ...
            age: 32,
            gender: 'male',
            bio: 'Teacher and coffee enthusiast. Looking for meaningful connections this cuffing season.',
            location: 'Queens, NY',
            photos: JSON.stringify(['/images/evan.jpg']),
            interested_in: JSON.stringify(['female'])
        },
        ...
        },
        {
            ...
            age: 26,
            gender: 'female',
            bio: 'Dancer and choreographer. Let\'s move together through this cuffing season!',
            location: 'Queens, NY',
            photos: JSON.stringify(['/images/diana.jpg']),
            interested_in: JSON.stringify(['male', 'female'])
        },
  ...
  `);
    ...
    for (const user of sampleUsers) {
        ...
        const result = insertUser.run(user.email, passwordHash, user.name, user.age, user.gender, user.bio, user.location, user.photos, user.interested_in);
