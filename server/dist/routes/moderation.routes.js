...
// Report a user
router.post('/report', auth_1.authenticateToken, (req, res) => {
    try {
...
// Block a user
router.post('/block', auth_1.authenticateToken, (req, res) => {
    try {
        const db = (0, db_1.getDatabase)();
        const userId = req.userId;
...
// Unblock a user
router.delete('/block/:blockedId', auth_1.authenticateToken, (req, res) => {
    try {
        const db = (0, db_1.getDatabase)();
        const userId = req.userId;
...
router.get('/blocked', auth_1.authenticateToken, (req, res) => {
    try {
        const db = (0, db_1.getDatabase)();
        const userId = req.userId;
